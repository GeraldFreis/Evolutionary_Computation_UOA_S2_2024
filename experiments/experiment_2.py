...
def run_experiment(file, opt_file, k, run_number, output_folder):
    ...
    population = Population(
        ...
        selection_params={"tournament_size": k // 4 * 2},
        mutation=Inversion,
        mutation_rate=0.9
    )
...
def experiment_2(output_folder, num_runs=1):
    population_sizes = [50]
    test_files = [
...
if __name__ == '__main__':
    ...
    output_folder = "results/experiment_2_results"
    # Specify the number of times the experiment should run
    num_runs = 30
    experiment_2(output_folder, num_runs)
